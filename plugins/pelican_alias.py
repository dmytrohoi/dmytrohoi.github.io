...
<meta http-equiv="refresh" content="0;url={destination_path}" /><script type="text/javascript">
    ...
    <body>
        ...
        If you are not redirected automatically, follow this <a href='{destination_path}'>link to example</a>.
    </body></html>"""
